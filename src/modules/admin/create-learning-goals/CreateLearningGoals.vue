        ...
        <div class="flex flex-row gap-4">
            ...
            <div class="flex flex-col items-center gap-2">
                <div class="flex items-center w-full mb-2">
                    <input type="range" min="102" max="130" v-model.number="zoomLevel" class="range range-primary flex-1" />
            ...
            <!-- Third column: 4 stacked maps with independent slider -->
            <div class="flex flex-col items-center gap-2">
                <div class="flex items-center w-full mb-2">
                    <input type="range" min="102" max="200" v-model.number="zoomLevel3" class="range range-primary flex-1" />
                    <span class="ml-2 w-10 text-right">{{ zoomLevel3 }}</span>
                </div>
                <div class="flex flex-col gap-2">
